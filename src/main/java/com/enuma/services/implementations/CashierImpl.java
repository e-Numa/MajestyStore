...
public class CashierImpl implements CashierServices {
    ...
    public void viewStock() {
      //View Stock.displayProducts();
        Updates.viewItems("GROCERIES");
        Updates.viewItems("FASTFOOD");
        Updates.viewItems("PASTRY");
        Updates.viewItems("DRINKS");
        Updates.viewItems("BEVERAGES");
        Updates.viewItems("DAIRY");
        Updates.viewItems("CLOTHING");
        Updates.viewItems("PHONES");
        Updates.viewItems("TOILETRIES");
        Updates.viewItems("DRUGS");
        Updates.viewItems("STATIONERY");
    }
}
